        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/all-customer')}}">Tất cả người dùng</a></li>
                    </ul>
                </li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand')}}">Tất cả thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/manage-order')}}">Tất cả đơn hàng</a></li>
                    </ul>
                </li>
