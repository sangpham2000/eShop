        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 padding-right">
                    <form class="form-cart" action="{{URL::to('/update-cart-quantity')}}" method="POST">
                    {{ csrf_field() }}
                        <div class="cart-title"><span>Giỏ hàng của bạn</span></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart_quantity">
                                                <div class="cart_quantity_button">
                                                    <input class="cart_quantity_input qty" type="number" min="1" name="quantity_value" value="{{$value_content -> qty}}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="total_area">
                                        <ul>
                                            <li>Tạm tính <span>{{Cart::subtotal(0).' '.'vnđ'}}</span></li>
                                            <li>Phí vận chuyển <span>Miên phí</span></li>
