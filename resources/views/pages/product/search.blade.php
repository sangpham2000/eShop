...
<div class="features_items"><!--features_items-->
    <h2 class="title text-center">Sản phầm tìm được</h2>
                ...
                <div class="single-products">
                    <a href="{{URL::to('product-details/'.$product -> product_id)}}">
                        <div class="productinfo text-center">
                            ...
                            <button type="submit" href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</button>
                        </div>
                    </a>
                </div>
            </div>
